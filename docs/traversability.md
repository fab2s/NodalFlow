...
Upon each iteration, the remaining Nodes in the flow will be recursed over. This is for example useful when a data generator needs some kind of manipulation(s) and / or actions on each of his "records".
